...
import com.openfeed.collectone.NoSuchAccountException;
import com.openfeed.collectone.model.Account;
import com.openfeed.collectone.model.impl.AccountImpl;
import com.openfeed.collectone.model.impl.AccountModelImpl;
...
public class AccountPersistenceImpl extends BasePersistenceImpl<Account>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(AccountModelImpl.ENTITY_CACHE_ENABLED,
			...
			AccountModelImpl.COMPANY_ID_COLUMN_BITMASK);
	 ...
	 */
	public Account create(int account_id) {
		Account account = new AccountImpl();

		account.setNew(true);
		account.setPrimaryKey(account_id);
	 ...
	 */
	public Account remove(int account_id)
		throws NoSuchAccountException, SystemException {
		return remove(Integer.valueOf(account_id));
	}
	...
	@Override
	public Account updateImpl(com.openfeed.collectone.model.Account account,
		...
		if (isNew || !AccountModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((accountModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Integer.valueOf(accountModelImpl.getOriginalCompany_Id())
					};
				...
				args = new Object[] {
						Integer.valueOf(accountModelImpl.getCompany_Id())
					};
	...
	protected Account toUnwrappedModel(Account account) {
		...
		accountImpl.setAccount_id(account.getAccount_id());
		accountImpl.setCompany_Id(account.getCompany_Id());
		accountImpl.setName(account.getName());
		accountImpl.setFirst_name(account.getFirst_name());
		accountImpl.setLast_name(account.getLast_name());
		accountImpl.setDate(account.getDate());
		accountImpl.setActive(account.isActive());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account findByPrimaryKey(int account_id)
		throws NoSuchAccountException, SystemException {
		Account account = fetchByPrimaryKey(account_id);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account fetchByPrimaryKey(int account_id) throws SystemException {
		Account account = (Account)EntityCacheUtil.getResult(AccountModelImpl.ENTITY_CACHE_ENABLED,
				AccountImpl.class, account_id);
		...
		if (account == null) {
			...
			try {
				...
				if (account != null) {
					...
					EntityCacheUtil.putResult(AccountModelImpl.ENTITY_CACHE_ENABLED,
						AccountImpl.class, account_id, _nullAccount);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Account> findByCompanyId(int company_Id)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Account> findByCompanyId(int company_Id, int start, int end)
		throws SystemException {
	...
	public List<Account> findByCompanyId(int company_Id, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Account account : list) {
				if ((company_Id != account.getCompany_Id())) {
					list = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account findByCompanyId_First(int company_Id,
		OrderByComparator orderByComparator)
		throws NoSuchAccountException, SystemException {
		Account account = fetchByCompanyId_First(company_Id, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account fetchByCompanyId_First(int company_Id,
		OrderByComparator orderByComparator) throws SystemException {
		List<Account> list = findByCompanyId(company_Id, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account findByCompanyId_Last(int company_Id,
		OrderByComparator orderByComparator)
		throws NoSuchAccountException, SystemException {
		Account account = fetchByCompanyId_Last(company_Id, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account fetchByCompanyId_Last(int company_Id,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByCompanyId(company_Id);

		List<Account> list = findByCompanyId(company_Id, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account[] findByCompanyId_PrevAndNext(int account_id,
		int company_Id, OrderByComparator orderByComparator)
		throws NoSuchAccountException, SystemException {
		Account account = findByPrimaryKey(account_id);
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, account, company_Id,
					orderByComparator, true);

			array[1] = account;

			array[2] = getByCompanyId_PrevAndNext(session, account, company_Id,
	...
	protected Account getByCompanyId_PrevAndNext(Session session,
		Account account, int company_Id, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(int company_Id) throws SystemException {
		for (Account account : findByCompanyId(company_Id)) {
			remove(account);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByCompanyId(int company_Id) throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.openfeed.collectone.model.Account")));
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANY_ID_2 = "account.company_Id = ?";
